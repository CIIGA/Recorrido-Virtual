...
$sql = "select Propietario,Calle,Colonia from implementta where Cuenta='$cuenta'";
$consulta = sqlsrv_query($cnx, $sql);
...
<body>
    <a-scene environment cursor="rayOrigin: mouse; fuse: false" raycaster="far: 10000; objects: a-link, .raycastable" renderer="antialias: true" webxr="referenceSpaceType: local">
        <a-entity id="rig" position="0 0 0">
            ...
            <a-camera id="camera" camera="active: true" look-controls="enabled: true" position="0 0 0">
            </a-camera>
        ...
        <!-- panel ficha -->
        <a-entity position="2 0.1 0.5" rotation="0 -110 0" panel-fichap visible="false" scale="0.001 0.001 0.001" geometry="primitive: plane; width: 2; height: 2.5" material="color: #333333; shader: flat; transparent: false">
            <!-- imagen -->
            <a-entity geometry="primitive: plane; width: 2; height: 2.5" material="src: #ficha-pdf-img; shader: flat; transparent: true" position="0 0 0.002">
            </a-entity>
            <!-- icono para quitar el panel -->
            <!-- la clase raycastable es para que se pueda presionar -->
            <a-plane id="fichap-close" position="0.9 1.2 0.01" height="0.1" width="0.2" scale="0.1 0 1" material="color: red" class="raycastable">
                <a-text value="X" align="center" position="0 0 0.01" color="white" scale="0.5 0.5 0.5"></a-text>
            </a-plane>

        </a-entity>
        <!-- panel fotos -->
        <a-entity position="2 0 -1.5" rotation="0 -50 0" panel-fotos visible="false" scale="0.001 0.001 0.001" geometry="primitive: plane; width: 1.5; height: 1.2" material="color: #333333; shader: flat; opacity: 0">
        ...
        <!-- panel datos -->
        <a-entity position="0 0.1 -2" panel-datos visible="false" scale="0.001 0.001 0.001" geometry="primitive: plane; width: 1.5; height: 1.8" material="color: #333333; shader: flat; transparent: false">
            <!-- imagen -->
            <a-entity geometry="primitive: plane; width: 1.5; height: 0.81" material="src: #p-image; shader: flat; transparent: true" position="0 0.495 0.002">
            </a-entity>
            <!--titulo-->
            <a-entity position="-0.68 -0.1 0" text="shader: msdf; anchor: left; width: 1.5; font: https://cdn.aframe.io/examples/ui/Viga-Regular.json; color: white; value: Cuenta: <?php echo $cuenta ?>">
            </a-entity>
            <!--descripcion-->
            <a-entity position="-0.68 -0.2 0" text="baseline: top; shader: msdf; anchor: left; font: https://cdn.aframe.io/examples/ui/Viga-Regular.json; color: white; value: Propietario: <?php echo $datos['Propietario'] ?> \n 
                  Direccion: C. <?php echo $datos['Calle'] ?>, <?php echo $datos['Colonia'] ?>, TIJUANA B.C; align: justify;"></a-entity>
        ...
        <!-- panel modelo position="-3 0.4 1"-->
        <a-entity position="-2.1 0.1 -1.5" rotation="0 50 0" panel-modelo visible="false" scale="0.001 0.001 0.001" geometry="primitive: plane; width: 1.5; height: 1.8" material="color: #333333; shader: flat; opacity: 0">

            <!-- Modelo 3D GLB scale="0.007 0.007 0.007"-->
            <?php if ($cuenta == 'RG008031') { ?>
                <a-entity position="0 -0.3 0" gltf-model="modelos/<?php echo $cuenta ?>.glb" scale="0.007 0.007 0.007" animation="property: rotation; to: 90 360 0; loop: true; dur: 9000;"></a-entity>
            <?php } else { ?>
                <a-entity position="0 -0.3 0" gltf-model="modelos/<?php echo $cuenta ?>.glb" scale="0.2 0.2 0.2" animation="property: rotation; to: 90 360 0; loop: true; dur: 9000;"></a-entity>
            <?php } ?>
            ...
            <a-link title="Visualizar Modelo" href="modelo.php?cuenta=<?php echo $cuenta ?>" position="0.5 -0.82 0.01" scale="0.3 0.1 1" visible="false">
            </a-link>
        </a-entity>
        <!-- panel pagos position="-2.1 0.4 -1.5"-->
        <a-entity position="-2.2 0.4 0.6" rotation="0 100 0" panel-pagos visible="false" scale="0.001 0.001 0.001" geometry="primitive: plane; width: 3; height: 1.5" material="color: #333333; shader: flat; transparent: false">
            <a-entity geometry="primitive: plane; width: 3; height: 1.5" material="src: #image-pagos; shader: flat; transparent: true" position="0 0 0.002">
            </a-entity>
            <!-- tabla pagos  -->
        ...
        <!-- foto 360 -->
        <a-sky src="fotos360/<?php echo $cuenta ?>.jpg" rotation="0 0 0"></a-sky>


        <a-assets>
            <!-- esta es la imagen para el panel fotos -->
            <img id="p-image" src="fotosPanel/<?php echo $cuenta ?>.png" crossorigin="anonymous" />
            <!-- imagenes docs -->
            <img id="ficha-pdf-img" src="docs/fichas/<?php echo $cuenta ?>.png" crossorigin="anonymous" />
        ...
        <a-entity position="0 0 0">
            ...
            <a-entity id="fichap-poster-button" position="2 -1 0.5" rotation="0 -110 0" mixin="p-poster" material="src: #fichap-img-poster" class="raycastable menu-button">
            ...
            <!-- poster fotos -->
            <a-entity id="fotos-poster-button" position="2 -1 -1.5" rotation="0 -50 0" mixin="p-poster" material="src: #fotos-img-poster" class="raycastable menu-button">
                <a-entity position="0 -0.3 0">
                    <!-- Texto con letra negra -->
            ...
            <!-- poster modelo position="-3 -1 1"-->
            <a-entity id="modelo-poster-button" position="-2 -1 -1.5" rotation="0 50 0" mixin="p-poster" material="src: #modelo-img-poster" class="raycastable menu-button">
                <a-entity position="0 -0.3 0">
                    <!-- Texto con letra negra -->
                    <a-text value="Modelo 3D" align="center" color="black" position="0 0 0.01" scale="0.5 0.5 0.5"></a-text>
                </a-entity>
            </a-entity>
            <!-- poster pagos position="-2 -1 -1.5"-->
            <a-entity id="pagos-poster-button" position="-2.2 -1 0.6" rotation="0 100 0" mixin="p-poster" material="src: #pagos-img-poster" class="raycastable menu-button">
                <a-entity position="0 -0.3 0">
                    <a-text value="Pagos" align="center" color="black" position="0 0 0.01" scale="0.5 0.5 0.5"></a-text>
                </a-entity>
            </a-entity>
            
            <a-entity position="0 2.5 -3" mixin="p-drone" material="src: #drone" class="raycastable" event-set__click="_target: #link; visible: true">
